...
Developers are fantastic at educating themselves on technology and project methodologies; however, decomposing a problem and being able to distill what is important from what is not will enable a good developer to become a great one. Ensure you should spend as much time working to understand the problem space as you do in the solution space.
...
## Optimize for the Overall System 
 ...
 > "When designing organisations, dependencies and the resulting handovers are the biggest challenge. Handovers are where teams get blocked, politics arise, technical integrations need careful management, and user experience can become fractured." Nick Tune
